...
exports.paymentDeviceCallback = exports.startDevicePayment = void 0;
 ...
 */
exports.startDevicePayment = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
 ...
 */
exports.paymentDeviceCallback = functions.https.onRequest(async (req, res) => {
    if (req.method !== 'POST') {
...
//# sourceMappingURL=paymentDevice.js.map